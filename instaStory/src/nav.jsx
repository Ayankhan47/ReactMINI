...
const Nav = () => {
    ...
    return (
        <>
            <nav className="h-[4vh] text-white w-full rounded-t-3xl flex items-center justify-between px-4 font-[monument] bg-black">
          <div className="left">
            <h2>
              {hour}:{minute}
            </h2>
